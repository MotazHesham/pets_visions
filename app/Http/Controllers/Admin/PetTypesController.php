...
class PetTypesController extends Controller
{
    public function index()
    {
        ...
        return view('admin.petTypes.index', compact('petTypes'));
    }
    ...
    public function show(PetType $petType)
    {
        ...
        $petType->load('petTypeAdoptionPets', 'petTypeStrayPets', 'petTypeUserPets', 'specializationsStores', 'specializationsPetCompanions');
