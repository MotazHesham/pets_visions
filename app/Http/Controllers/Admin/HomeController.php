...
class HomeController
{
    public function index()
    {
        ...
        $settings3 = [
            'chart_title'           => 'عدد المستضيفين',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Hosting',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
        ...
        $settings4 = [
            'chart_title'           => 'عدد محبي الحيوانات الأليفة',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings5 = [
            'chart_title'        => 'الاحصائيات',
            'chart_type'         => 'pie',
            'report_type'        => 'group_by_string',
            'model'              => 'App\Models\AffiliationAnalytic',
            'group_by_field'     => 'model_type',
            'aggregate_function' => 'count',
            'filter_field'       => 'created_at',
            'column_class'       => 'col-md-4',
            'entries_number'     => '5',
            'translation_key'    => 'affiliationAnalytic',
        ];

        $chart5 = new LaravelChart($settings5);

        $settings6 = [
            'chart_title'        => 'احصائيات',
            'chart_type'         => 'line',
            'report_type'        => 'group_by_string',
            'model'              => 'App\Models\AffiliationAnalytic',
            'group_by_field'     => 'model_type',
