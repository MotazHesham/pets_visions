...
class HostingServicesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.hostingServices.index', compact('hostingServices'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.hostingServices.create');
    }
    ...
    public function store(StoreHostingServiceRequest $request)
    {
        ...
        return redirect()->route('frontend.hosting-services.index');
    }
    ...
    public function edit(HostingService $hostingService)
    {
        ...
        return view('frontend.hostingServices.edit', compact('hostingService'));
    }
    ...
    public function show(HostingService $hostingService)
    {
        ...
        return view('frontend.hostingServices.show', compact('hostingService'));
    }
