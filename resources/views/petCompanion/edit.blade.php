...
@section('content')
    <div class="card">
        ...
        <div class="card-body"> 
            <form method="POST" action="{{ route('pet-companion.profile.updateProfile') }}" enctype="multipart/form-data">  
                @csrf
...
@section('scripts')
    <script>
        Dropzone.options.photoDropzone = {
            url: '{{ route('pet-companion.storeMedia') }}',
            maxFilesize: 4, // MB
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('pet-companion.storeCKEditorImages') }}',
                                            true);
