        ...
        $(function() {
            let dtButtons = $.extend(true, [], $.fn.dataTable.defaults.buttons)
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('pet-companion.pet-companion-reviews.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('pet-companion.pet-companion-reviews.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
                    ...
                    {
                        data: 'pet_companion_nationality',
                        name: 'pet_companion.nationality'
                    },
                    {
                        data: 'user_name',
                        name: 'user.name'
