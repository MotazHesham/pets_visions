...
@section('content')
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('store.products.create') }}">
...
@section('scripts')
    ...
    <script>
        function update_statuses(el,type){
            ...
            $.post('{{ route('store.products.update_statuses') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status, type:type}, function(data){
                if(data == 1){
        ...
        $(function() {
            let dtButtons = $.extend(true, [], $.fn.dataTable.defaults.buttons)
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('store.products.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('store.products.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
