...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.stray-pets.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('missing_place') ? 'is-invalid' : '' }}" type="text"
                        name="missing_place" id="missing_place" value="{{ old('missing_place', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('receiving_place') ? 'is-invalid' : '' }}" type="text"
                        name="receiving_place" id="receiving_place" value="{{ old('receiving_place', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('affiliation_link') ? 'is-invalid' : '' }}" type="text"
                        name="affiliation_link" id="affiliation_link" value="{{ old('affiliation_link', '') }}">
