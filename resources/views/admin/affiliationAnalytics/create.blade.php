...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.affiliation-analytics.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_of_clicks') ? 'is-invalid' : '' }}" type="number" name="num_of_clicks" id="num_of_clicks" value="{{ old('num_of_clicks', '') }}" step="1">
