    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clinics.update", [$clinic->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clinic_phone') ? 'is-invalid' : '' }}" type="text" name="clinic_phone" id="clinic_phone" value="{{ old('clinic_phone', $clinic->clinic_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unified_phone') ? 'is-invalid' : '' }}" type="text" name="unified_phone" id="unified_phone" value="{{ old('unified_phone', $clinic->unified_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" type="text" name="short_description" id="short_description" value="{{ old('short_description', $clinic->short_description) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('about_us') ? 'is-invalid' : '' }}" name="about_us" id="about_us">{!! old('about_us', $clinic->about_us) !!}</textarea>
