...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Paramedic">
                <thead>
                    <tr>
                        <th width="10">
...
@section('scripts')
    ...
    <script>
        function update_statuses(el,type){
            ...
            $.post('{{ route('admin.paramedics.update_statuses') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status, type:type}, function(data){
                if(data == 1){
        ...
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.paramedics.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
            ...
            let table = $('.datatable-Paramedic').DataTable(dtOverrideGlobals);
