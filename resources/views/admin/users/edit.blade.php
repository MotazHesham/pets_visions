    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identity_num') ? 'is-invalid' : '' }}" type="text" name="identity_num" id="identity_num" value="{{ old('identity_num', $user->identity_num) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_position') ? 'is-invalid' : '' }}" type="text" name="user_position" id="user_position" value="{{ old('user_position', $user->user_position) }}">
