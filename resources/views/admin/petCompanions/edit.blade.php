...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pet-companions.update", [$petCompanion->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationality') ? 'is-invalid' : '' }}" type="text" name="nationality" id="nationality" value="{{ old('nationality', $petCompanion->nationality) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('experience') ? 'is-invalid' : '' }}" name="experience" id="experience">{!! old('experience', $petCompanion->experience) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('affiliation_link') ? 'is-invalid' : '' }}" type="text" name="affiliation_link" id="affiliation_link" value="{{ old('affiliation_link', $petCompanion->affiliation_link) }}" required>
