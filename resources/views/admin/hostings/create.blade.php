    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hostings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hosting_name') ? 'is-invalid' : '' }}" type="text" name="hosting_name" id="hosting_name" value="{{ old('hosting_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hosting_phone') ? 'is-invalid' : '' }}" type="text" name="hosting_phone" id="hosting_phone" value="{{ old('hosting_phone', '') }}" required>
