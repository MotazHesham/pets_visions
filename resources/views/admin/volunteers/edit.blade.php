    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.volunteers.update", [$volunteer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $volunteer->first_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $volunteer->last_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $volunteer->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $volunteer->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender">
                    ...
                    @foreach(App\Models\Volunteer::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $volunteer->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" name="age" id="age">
                    ...
                    @foreach(App\Models\Volunteer::AGE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('age', $volunteer->age) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('age'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('experience') ? 'is-invalid' : '' }}" type="text" name="experience" id="experience" value="{{ old('experience', $volunteer->experience) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Volunteer::FIELDS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('fields') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="fields_{{ $key }}" name="fields" value="{{ $key }}" {{ old('fields', $volunteer->fields) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('period_time') ? 'is-invalid' : '' }}" name="period_time" id="period_time">
                    ...
                    @foreach(App\Models\Volunteer::PERIOD_TIME_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('period_time', $volunteer->period_time) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $volunteer->note) }}</textarea>
                @if($errors->has('note'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note') }}
                    </div>
