...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.delivery-pets.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('pets_details') ? 'is-invalid' : '' }}" name="pets_details" id="pets_details">{{ old('pets_details') }}</textarea>
