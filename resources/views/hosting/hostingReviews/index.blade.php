...
@section('content')
    {{-- <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('hosting.hosting-reviews.create') }}">
        ...
        $(function() {
            let dtButtons = $.extend(true, [], $.fn.dataTable.defaults.buttons)
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('hosting.hosting-reviews.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('hosting.hosting-reviews.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
                    ...
                    {
                        data: 'hosting_hosting_phone',
                        name: 'hosting.hosting_phone'
                    },
                    {
                        data: 'user_name',
                        name: 'user.name'
