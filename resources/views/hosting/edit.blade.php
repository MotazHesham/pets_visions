...
@section('content') 
    <form method="POST" action="{{ route('hosting.profile.updateProfile') }}" enctype="multipart/form-data"> 
        @csrf 
...
@section('scripts')
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('hosting.hostings.storeCKEditorImages') }}',
                                            true);
    ...
    <script>
        Dropzone.options.logoDropzone = {
            url: '{{ route('hosting.hostings.storeMedia') }}',
            maxFilesize: 4, // MB
