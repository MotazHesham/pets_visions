    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.user-pets.update", [$userPet->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.userPet.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $userPet->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="dob" id="dob" value="{{ old('dob', $userPet->dob) }}" required>
                            @if($errors->has('dob'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dob') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fasila" id="fasila" value="{{ old('fasila', $userPet->fasila) }}" required>
...
<script>
    ...
    url: '{{ route('frontend.user-pets.storeMedia') }}',
    maxFilesize: 4, // MB
