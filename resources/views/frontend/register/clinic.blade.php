                    ...
                    <div class=" checkout-box">
                        ...
                        <div class="checkout-body ">
                            ...
                            <form class="checkout-form" method="POST" action="{{ route('frontend.register.store') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="user_type" value="clinic" id="">
                                <!-- chek menu bar -->
                                <ul class="menu-bar">
                                ...
                                <div class="checkout-fr-box">
                                    <div class="form-card"> 
                                        <h3 class="form-title">{{ trans('frontend.register.clinic_info') }}</h3>
                                        <div class="form-group">
                                            <input type="text" name="clinic_name" value="{{ old('clinic_name') }}" placeholder="{{ trans('frontend.register.clinic_name') }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="clinic_phone" value="{{ old('clinic_phone') }}" placeholder="{{ trans('frontend.register.clinic_phone') }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="unified_phone" value="{{ old('unified_phone') }}" placeholder="{{ trans('frontend.register.unified_phone') }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('frontend.register.certification') }}</label>
