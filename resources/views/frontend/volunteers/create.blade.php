    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.volunteers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Volunteer::FIELDS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="fields_{{ $key }}" name="fields" value="{{ $key }}" {{ old('fields', '') === (string) $key ? 'checked' : '' }}>
