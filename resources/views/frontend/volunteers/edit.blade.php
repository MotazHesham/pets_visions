    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.volunteers.update", [$volunteer->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="first_name">{{ trans('cruds.volunteer.fields.first_name') }}</label>
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $volunteer->first_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $volunteer->last_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $volunteer->phone) }}">
                            @if($errors->has('phone'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('phone') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $volunteer->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="experience" id="experience" value="{{ old('experience', $volunteer->experience) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Volunteer::FIELDS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="fields_{{ $key }}" name="fields" value="{{ $key }}" {{ old('fields', $volunteer->fields) === (string) $key ? 'checked' : '' }}>
                                    <label for="fields_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="period_time" id="period_time">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="note" id="note">{{ old('note', $volunteer->note) }}</textarea>
                            @if($errors->has('note'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('note') }}
                                </div>
