                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clinics.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="clinic_name" id="clinic_name" value="{{ old('clinic_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="clinic_phone" id="clinic_phone" value="{{ old('clinic_phone', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unified_phone" id="unified_phone" value="{{ old('unified_phone', '') }}">
