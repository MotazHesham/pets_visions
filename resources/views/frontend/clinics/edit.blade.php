                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clinics.update", [$clinic->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="clinic_name" id="clinic_name" value="{{ old('clinic_name', $clinic->clinic_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="clinic_phone" id="clinic_phone" value="{{ old('clinic_phone', $clinic->clinic_phone) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unified_phone" id="unified_phone" value="{{ old('unified_phone', $clinic->unified_phone) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="short_description" id="short_description" value="{{ old('short_description', $clinic->short_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $clinic->address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="about_us" id="about_us">{!! old('about_us', $clinic->about_us) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="about_us_image-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="user_id" id="user_id">
                                @foreach($users as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $clinic->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('user'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="certification-dropzone">
                            </div>
...
<script>
    ...
    url: '{{ route('frontend.clinics.storeMedia') }}',
    maxFilesize: 5, // MB
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.clinics.storeCKEditorImages') }}', true);
