                    ...
                    <div class="breadcrumb-contain">
                        <div>
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('frontend.clinics.show', $clinic->id) }}">{{ $clinic->clinic_name }}</a>
                                </li>
                                <li><i class="fa fa-angle-double-left"></i></li>
            ...
            <div class=" row blog-contact  section-big-pb-space">
                <div class="col-sm-12  ">
                    <div class="creative-card" style="background:none; padding:0">
                        ...
                        <form class="theme-form" action="{{ route('frontend.clinic-reviews.store') }}" method="POST">
                            @csrf
                            <input type="hidden" name="clinic_id" value="{{ $clinic->id }}" id="">
