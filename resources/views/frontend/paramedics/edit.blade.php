            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.paramedics.update", [$paramedic->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="active" id="active" value="1" {{ $paramedic->active || old('active', 0) === 1 ? 'checked' : '' }} required>
                                <label class="required" for="active">{{ trans('cruds.paramedic.fields.active') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from_time" id="from_time" value="{{ old('from_time', $paramedic->from_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to_time" id="to_time" value="{{ old('to_time', $paramedic->to_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="affiliation_link" id="affiliation_link" value="{{ old('affiliation_link', $paramedic->affiliation_link) }}" required>
