                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.paramedics.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from_time" id="from_time" value="{{ old('from_time') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to_time" id="to_time" value="{{ old('to_time') }}" required>
