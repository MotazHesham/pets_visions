                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.newss.update", [$news->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_description" id="short_description">{{ old('short_description', $news->short_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $news->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $news->published || old('published', 0) === 1 ? 'checked' : '' }}>
                                <label for="published">{{ trans('cruds.news.fields.published') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="featured" id="featured" value="1" {{ $news->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                                <label for="featured">{{ trans('cruds.news.fields.featured') }}</label>
                            </div>
