        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.hosting.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.hostings.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hosting_name" id="hosting_name" value="{{ old('hosting_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hosting_phone" id="hosting_phone" value="{{ old('hosting_phone', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="hosting_type" id="hosting_type" required>
                                ...
                                @foreach(App\Models\Hosting::HOSTING_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('hosting_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="about_us" id="about_us">{!! old('about_us') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="affiliation_link" id="affiliation_link" value="{{ old('affiliation_link', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="hosting_services[]" id="hosting_services" multiple required>
                                @foreach($hosting_services as $id => $hosting_service)
                                    <option value="{{ $id }}" {{ in_array($id, old('hosting_services', [])) ? 'selected' : '' }}>{{ $hosting_service }}</option>
                                @endforeach
                            </select>
