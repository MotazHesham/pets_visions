                    ...
                    <div class="breadcrumb-contain">
                        <div>
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('frontend.hostings.show', $hosting->id) }}">{{ $hosting->hosting_name }}</a>
                                </li>
                                <li><i class="fa fa-angle-double-left"></i></li>
            ...
            <div class=" row blog-contact  section-big-pb-space">
                <div class="col-sm-12  ">
                    <div class="creative-card" style="background:none; padding:0">
                        ...
                        <form class="theme-form" action="{{ route('frontend.hosting-reviews.store') }}" method="POST">
                            @csrf
                            <input type="hidden" name="hosting_id" value="{{ $hosting->id }}" id="">
