    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.hostings.update", [$hosting->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hosting_name" id="hosting_name" value="{{ old('hosting_name', $hosting->hosting_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hosting_phone" id="hosting_phone" value="{{ old('hosting_phone', $hosting->hosting_phone) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="hosting_type" id="hosting_type" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $hosting->address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="about_us" id="about_us">{!! old('about_us', $hosting->about_us) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_description" id="short_description">{{ old('short_description', $hosting->short_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="affiliation_link" id="affiliation_link" value="{{ old('affiliation_link', $hosting->affiliation_link) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="identity_photo-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="hosting_services[]" id="hosting_services" multiple required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="commercial_register_photo-dropzone">
                            </div>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.hostings.storeCKEditorImages') }}', true);
...
<script>
    ...
    url: '{{ route('frontend.hostings.storeMedia') }}',
    maxFilesize: 4, // MB
