                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.update", [$product->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="current_stock" id="current_stock" value="{{ old('current_stock', $product->current_stock) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="details" id="details">{!! old('details', $product->details) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="video_link" id="video_link" value="{{ old('video_link', $product->video_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tags" id="tags" value="{{ old('tags', $product->tags) }}">
                            @if($errors->has('tags'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tags') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="affiliation_link" id="affiliation_link" value="{{ old('affiliation_link', $product->affiliation_link) }}">
