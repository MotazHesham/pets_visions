                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.stores.update", [$store->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="store_phone" id="store_phone" value="{{ old('store_phone', $store->store_phone) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $store->address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="domain" id="domain" value="{{ old('domain', $store->domain) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="specializations[]" id="specializations" multiple>
...
<script>
    ...
    url: '{{ route('frontend.stores.storeMedia') }}',
    maxFilesize: 5, // MB
